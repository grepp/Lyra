...
async def websocket_terminal(websocket: WebSocket):
    ...
    if pid == 0:
        ...
        try:
            ...
            async def read_from_pty():
                while True:
                    try:
                        ...
                        # We use a small sleep to avoid tight loop, or add_reader if supported?
                        # asyncio.add_reader calls a callback.
                        
                        # Let's use run_in_executor for the blocking read if strictly strictly blocking,
                        # but we made it non-blocking.
            ...
            # sending SIGHUP might be needed
